...
class Statistics(_w: Double, _h: Double) : FixedSizeContainer(_w, _h) {
    ...
    private val H = _h
    init {
        blackboard = solidRect(W, H, RGBA(0, 0, 0, 150)).xy(0, 0)

        centerLine = solidRect(1, 1, RGBA(0, 0, 0, 0)) {
            position(W / 2 - 0.5, H / 2 - 0.5)
        }
